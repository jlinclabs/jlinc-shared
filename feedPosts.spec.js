...
describe('feedPosts', function(){
  describe('createFeedPostUid', function(){
    it('should generate uuids', function(){
      expect(createFeedPostUid).to.be.a('function');
      expect(createFeedPostUid()).to.be.a('string');
      expect(createFeedPostUid()).to.have.length(32);
      const n = 1000;
      const set = new Set;
  ...
  it('should work like this', function(){
    ...
    const organizationPublishedPost =
      publishOrganizationForumPost({
        ...
        posterUserDid: 'jlinc:did:acuratoroftheupmostaccord',
      });

    expect(organizationPublishedPost).to.matchPattern({
      ...descendFromFeedPost(organizationFormRootPostAsUser),
      uid: _.isFeedPostUid,
    ...
    expect(organizationFormRepost).to.matchPattern({
      ...descendFromFeedPost(userPublishedRepost),
      feedOrganizationApikey: 'exon',
      publishable: false,
    });
